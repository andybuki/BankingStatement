...
actual fun provideStrings(): AppStrings = AppStrings(
    ...
    importErrorTitle = stringResource(R.string.import_error_title),
    importErrorFileCouldNotBeRead = stringResource(R.string.import_error_file_could_not_be_read),
    importErrorUnsupportedFormatDetail = stringResource(R.string.import_error_unsupported_format_detail),
    importErrorNotBankStatementDetail = stringResource(R.string.import_error_not_bank_statement_detail),
    importErrorPdfInvalid = stringResource(R.string.import_error_pdf_invalid),
    importErrorPdfNoText = stringResource(R.string.import_error_pdf_no_text),
    importErrorParserNotFound = stringResource(R.string.import_error_parser_not_found),
    importErrorGeneric = stringResource(R.string.import_error_generic),
    importErrorWhatHappened = stringResource(R.string.import_error_what_happened),
    importErrorWhatYouCanDo = stringResource(R.string.import_error_what_you_can_do),
    ...
    retryImport = stringResource(R.string.retry_import),
