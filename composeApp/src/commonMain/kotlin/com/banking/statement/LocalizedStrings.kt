...
data class AppStrings(
    ...
    val importErrorBankNotSupported: String,
...
fun defaultEnglishStrings() = AppStrings(
    ...
    importErrorBankNotSupported = "Bank not supported? Email moneylupe.info@gmail.com to request it — we'll add it very soon!",
